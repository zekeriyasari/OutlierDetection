...
# Note that the model is fitted on the inlier data having no contamination. Therefore, in this sense, one class svm is
# generally a novelty detector in this sense.
clf.fit(x_inliers)
